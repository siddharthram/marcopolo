...
- (void)readFromDisk
{
    ...
    if ([listFromDisk count] == 0) {
        ...
        listFromDisk = [@[[@{kJobImageKey : kDummyKey1, kJobStatusKey : @"PROCESSING",  kJobSubmissionTimeKey : [NSDate dateWithTimeIntervalSinceNow:-1200]} mutableCopy],
                        [@{kJobImageKey : kDummyKey2, kJobStatusKey : @"DONE!", kJobFinishTimeKey : [NSDate dateWithTimeIntervalSinceNow:-1500], kJobTranscriptionKey : @"Blah blah blah blah.  Blah blah blah blah blah.  Blah blah blah blah blah blah blah blah blah blah.", kJobRatingKey : @"Good", kJobRatingCommentKey : @"Wow! Better than sliced bread."} mutableCopy],
                        [@{kJobImageKey : kDummyKey3, kJobStatusKey : @"DONE!", kJobFinishTimeKey : [NSDate dateWithTimeIntervalSinceNow:-180000], kJobTranscriptionKey : @"Gobbledygook gobbledygook gobbledygook gobbledygook.  Blah blah gobbledygook blah blah.  Gobbledygook blah blah gobbledygook blah blah blah blah blah blah."} mutableCopy],
