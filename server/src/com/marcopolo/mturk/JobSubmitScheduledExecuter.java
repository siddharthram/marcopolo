...
/**
 * For submitting job to mturk periodically
 *
 */
public class JobSubmitScheduledExecuter extends ScheduledThreadPoolExecutor {

        public JobSubmitScheduledExecuter(int corePoolSize) {
                super(corePoolSize);
        }
